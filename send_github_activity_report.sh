...
# ===== CYBERSHIELD GITHUB ACTIVITY REPORT v2.0.4 =====
...
@media only screen and (max-width: 600px) { 
    ...
    .footer-watermark { width: 40px; margin-top: 3em; } 
...
<div class='footer-version'>⚙️ CyberShield GitHub Activity Report v2.0.4</div>"
